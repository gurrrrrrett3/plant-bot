...
client.on("ready", () => {
    ...
    const commands = [
        new SlashCommandBuilder()
            .setName("water")
            .setDescription("Water the plant"),
        new SlashCommandBuilder()
            .setName("reset")
...
async function setPfp(alive: boolean) {
    ...
    if (alive) {
        client.user?.setAvatar("https://cdn.discordapp.com/attachments/882015231126163507/1008977396763996251/unknown.png").catch(() => {})
    } else {
        client.user?.setAvatar("https://cdn.discordapp.com/attachments/882015231126163507/1008977534907580476/unknown.png").catch(() => {})
    }
